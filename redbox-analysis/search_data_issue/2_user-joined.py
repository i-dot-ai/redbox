...
user_path = '/Users/morgan.frodsham/Documents/redbox_data/user.csv'
chat_joined_path = '/Users/morgan.frodsham/PycharmProjects/redbox-user-research/data_issue/chat_joined.csv'
...
user_joined_df['selected_files']=user_joined_df['selected_files'].fillna('')
user_joined_df['file_select_count']=user_joined_df['selected_files'].apply(lambda x: len(x.split(',')))
