...
def test_elasticsearch_client_connection(es_client, es_storage_handler):
    """
...
def test_elasticsearch_write_read_item(es_storage_handler, file_belonging_to_alice):
    """
...
def test_elastic_write_read_delete_items(es_storage_handler):
    """
...
def test_elastic_delete_item(es_storage_handler, file_belonging_to_alice):
    """
...
def test_elastic_delete_user_item(es_storage_handler, file_belonging_to_alice, alice):
    """
    Given that I have a saved object
    When I call delete_item on it
    Then I expect to not be able to read the item
