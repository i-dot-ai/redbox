...
test-django:
	...
	docker-compose run --env ENVIRONMENT="TEST" --env PYTHONPATH=/app/django_app/ django-app poetry run pytest /app/django_app/tests/ -v --cov=redbox_app.redbox_core --cov-fail-under 10
