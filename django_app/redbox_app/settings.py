...
MIN_MESSAGE_THROTTLE_SECONDS = env.int("MIN_MESSAGE_THROTTLE_SECONDS", 1)
MAX_MESSAGE_THROTTLE_SECONDS = env.int("MAX_MESSAGE_THROTTLE_SECONDS", 10)
MESSAGE_THROTTLE_CONSTANT = env.float("MESSAGE_THROTTLE_CONSTANT", 0.1)
