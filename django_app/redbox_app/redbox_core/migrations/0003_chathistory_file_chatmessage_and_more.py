    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file_type', models.CharField(choices=[('.eml', 'Eml'), ('.html', 'Html'), ('.json', 'Json'), ('.md', 'Md'), ('.msg', 'Msg'), ('.rst', 'Rst'), ('.rtf', 'Rtf'), ('.txt', 'Txt'), ('.xml', 'Xml'), ('.csv', 'Csv'), ('.doc', 'Doc'), ('.docx', 'Docx'), ('.epub', 'Epub'), ('.odt', 'Odt'), ('.pdf', 'Pdf'), ('.ppt', 'Ppt'), ('.pptx', 'Pptx'), ('.tsv', 'Tsv'), ('.xlsx', 'Xlsx'), ('.htm', 'Htm')])),
