locals {
  ...
  worker_environment_variables = {
    ...
    "UNSTRUCTURED_HOST" : "${core_api_service_discovery_service.service_discovery_service.name}.${aws_service_discovery_private_dns_namespace.private_dns_namespace.name}",
  }
