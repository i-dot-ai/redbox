			...
			<div class="govuk-grid-column-two-thirds">
				{#if department === 'uktrade'}
					...
					<p class="govuk-body-l govuk-!-margin-bottom-7">
						...
						directly with the AI to assist you in your work. You can use up to, and including,
						Official documents.
					</p>
...
<div class="govuk-width-container">
	<div class="govuk-grid-row">
		<div class="govuk-grid-column-two-thirds">
			...
			<p class="govuk-body">
				You can communicate with your Redbox and ask questions of the documents contained within.
				Use Redbox to unlock deeper insights in the various documents you have uploaded, pulling
				together summaries of individual or combined documents.
			</p>
